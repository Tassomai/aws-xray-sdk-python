...
class XRayTracedCursor(wrapt.ObjectProxy):
    ...
    def execute(self, query, *args, **kwargs):
        ...
        add_sql_meta(self._xray_meta, query=query)
    ...
    def callproc(self, proc, args):
        ...
        add_sql_meta(self._xray_meta, proc=proc)
        return self.__wrapped__.callproc(proc, args)


def add_sql_meta(meta, query=None, proc=None):
    ...
    if proc is not None:
        sql_meta['sanitized_query'] = 'CALL {}'.format(proc)
